...
MESSAGE="VMware GIT CLI Client" + misc.MOVE + "Current Profile: " + misc.GREEN + misc.UNDERLINE + get_latest_profile().upper() + misc.RESET
...
@click.option('-p', '--profile', 'user_profile', help='user profile for git operations', required=False, default=get_latest_profile())
@click.pass_context
